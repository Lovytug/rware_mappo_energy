...
class AgentAgentRelationBlock(BaseRelationBlock):
    ...
    def _build_features_vector(self, agent_1, agent_2):
        ...
        return [
            ...
            agent_1.direction/4.0, agent_1.carring_shelf, agent_1.energy/self.cfg.max_energy,

            agent_2.x/self.cfg.max_width, agent_2.y/self.cfg.max_height, 
            agent_2.direction/4.0, agent_2.carring_shelf, agent_2.energy/self.cfg.max_energy,
