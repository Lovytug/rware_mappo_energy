from param_adapter.layers_adapter import LayersParamsAdapter

class GenerateLayers:
    def __init__(self, data):
        self.layers: str

        adapter = LayersParamsAdapter(data)
        ...
        self.charging_stations: list[tuple[int, int]] = [self._validate_pair(p) for p in params.charging_stations]
    ...
    def _validate_no_overlapping_coords(self):
        all_list = self.gates + self.shelves + self.charging_stations
        unique = set(all_list)
